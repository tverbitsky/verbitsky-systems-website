// Verbitsky Systems - Main JavaScript with URL Routing
...
function showPageByRoute(pageId) {
    // Hide all pages
    ...
    // Update page title
    const titles = {
        'home': 'Verbitsky Systems - Industrial AI Solutions',
        'about': 'About Us - Verbitsky Systems',
        'ai-assistant': 'AI Assistant - Verbitsky Systems',
        'knowledge-base': 'Knowledge Base - Verbitsky Systems',
        'support': 'Support - Verbitsky Systems',
        'contact': 'Contact - Verbitsky Systems'
    };
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add click handlers to other internal links
